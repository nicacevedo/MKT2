...
3\. Regresión con interacciones "Branch x Customer type x Month" y "Gender x Payment x Product line", pues se vio en el EDA cuadrimensional ciertas variaciones notables en la variable de interés. a. Branch x Customer type x Month: en el gráfico N°48, se vieron variaciones según este tipo de variables, por ejemplo, según tienda, varía el Rating, lo mismo para tipo de cliente, y que estos efectos también varían según el mes.
...
-   Las variables por sí solas pueden no explicar fenómenos complejos como la decisión de qué nivel de satisfacción se tiene con una atención. Muchas cosas afectan en conjunto.

-   La regresión lineal no siempre es la solución. Otros modelos pueden explicar fenómenos complejos de mejor manera. Sin embargo, es el único modelo con el que podemos hacer inferencia estadística

-   Es necesario comprender más a fondo cada uno de los modelos para poder ocuparlos de ejor manera y discernir en qué situación ocupar cada uno y cómo trabajar los datos de manera que se adapte de la mejor manera a cada modelo y estos entreguen resultados relevantes

-   Los métodos de selección tuvieron mejor rendimiento en general, lo que puede deberse a fenómenos que no podemos ver a simple vista, sino que guardan relación con cad aposbile variable y las interacciones

-   Si bien nada predice demasiado bien, una mejora de 1% puede significar tomar medida que beneficien a la marca/lo que sea

-   La inferencia bayesiana se adapta de muy buena manera, tanto con una distribución de interés directa como con una distribución posterior y un prior de distribución de los mismos parámetros (pavlo rellena)
